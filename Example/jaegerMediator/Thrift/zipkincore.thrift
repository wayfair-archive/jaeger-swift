...
struct Span {
  ...
  6: optional list<Annotation> annotations, # all annotations/events that occured, sorted by timestamp
  8: optional list<BinaryAnnotation> binary_annotations # any binary annotations
